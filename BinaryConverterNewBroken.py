    ...
    def openFile(self):
        ...
        if self.file_chosen == '':
            try:
                ...
                # file chosen variable will now hold location of file from previous instance of function
                self.file_chosen = str(self._previousFile[0])
                emptyCanvas = False
            except Exception:
                self.filePath.config(text="No file selected")
        ...
        # Saving location of previous open file from this instance of function
        self._previousFile = [str(self.file_chosen)]
