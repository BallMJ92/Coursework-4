...
class BinaryConverter(Frame):
    ...
    # Initialising canvas size variable as global for functions to access
    global CANVAS_SIZE    
    ...
    def __init__(self, master=None):
        ...
        self.canvasLeft = Canvas(width=width, height=height, bg="white")
        # Aligning left canvas
        self.canvasLeft.grid(column=1, row=3)

        # Creating right canvas
        self.canvasRight = Canvas(width=width, height=height, bg="white")
